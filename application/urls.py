...
urlpatterns = [
    ...
    path('vizualizare-disciplina/<str:pk>/adaugare-proiect-nou/', application_views.adaugareProiect, name='adaugareProiect'),
    path('vizualizare-disciplina/<str:pk>/vizualizare-proiecte/', application_views.vizualizareProiecte, name='vizualizareProiecte'),
